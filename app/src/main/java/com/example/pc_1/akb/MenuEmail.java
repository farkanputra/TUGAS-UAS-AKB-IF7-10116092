    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        send1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(android.content.Intent.EXTRA_EMAIL, new String[]{"farkanp@gmail.com"});
        ...
        send2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_SEND);
                intent.putExtra(android.content.Intent.EXTRA_EMAIL, new String[]{"farkanp@email.unikom.ac.id"});
                intent.putExtra(intent.EXTRA_SUBJECT, "Primus Suggestion or Issue");
                intent.setType("text/plain");
                if (intent.resolveActivity(getActivity().getPackageManager()) != null) {
                    getActivity().startActivity(Intent.createChooser(intent, "Send Email using:"));
